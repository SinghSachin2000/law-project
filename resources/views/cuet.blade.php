...
<div class="resultsec w-full">
    ...
    <div class="text-white font-bold text-6xl">CUET (English Medium)</div>
...
<div class="flex flex-col justify-center items-center gap-2 mt-4">
    <div class="text-red-500">CUET</div>
    <div class="text-3xl font-bold ">Let’s Discover cuet Courses</div>
